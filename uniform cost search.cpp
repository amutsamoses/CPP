...
vector<int> uniformed_cost_search(vector<int> goal, int start)
{
	//minimum cost upto
...
int main()
{
	...
	//get the answer
	vector<int> answer = uniformed_cost_search(goal, 0);
